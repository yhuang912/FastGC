...
public class OptEDCORE_3Lplus4_L extends CompositeCircuit {
    private final int L;
    ...
    public OptEDCORE_3Lplus4_L(int l, int s) {
	super(3*l+4, l, 5, "OptEDCORE_" + (3*l+4) + "_" + l);
	L = l;
	sigma = s;
    }
	...
	subCircuits[EDT]   = new EDT_2L_1(sigma);
	...
	for (int i = 0; i < L; i++) {
	    inputWires[i+    4].connectTo(subCircuits[MINB].inputWires, i+L);
